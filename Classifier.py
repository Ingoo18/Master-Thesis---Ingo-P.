...
# Specify the directory containing your images (update the path as needed)
...
data = tf.keras.utils.image_dataset_from_directory(
    ...
    labels='inferred',
    label_mode='int',
    batch_size=None,  # Load all data without batching
    image_size=(256, 256),
    shuffle=True
)
...
# Convert the dataset to a NumPy array to use train_test_split
